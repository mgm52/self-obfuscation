...
class AdjectiveFitEvaluator:
    ...
    def __init__(self, data_dir: str, output_dir: Optional[str] = None, model: str = "gpt-4o-mini",
        ...
        Args:
            ...
            output_dir: Directory to save the mega dataset (defaults to data/synthetic_rating/outputs)
        ...
        self.output_dir = Path(output_dir) if output_dir else Path("data/synthetic_rating/outputs")
        self.model = model
...
def main():
    ...
    parser.add_argument("--data_dir", required=True, help="Directory of generate_synthetic_data.py output JSONs to evaluate (e.g. data/synthetic_generation/outputs/<timestamp>)")
    parser.add_argument("--output_dir", help="Output directory (default: data/synthetic_rating/outputs)")
