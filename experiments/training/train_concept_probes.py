...
if __name__ == "__main__":
    ...
    # --- Core arguments ---
    parser.add_argument("--dataset_path", type=str, default="data/synthetic_rating/outputs/mega_dataset_evaluated_20250729_144844_harm_batch_train.json", help="Path to the evaluated mega dataset JSON file.")
    parser.add_argument("--output_dir_base", type=str, default="outputs/probe_checkpoints", help="Base directory to save outputs.")
