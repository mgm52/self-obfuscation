...
def run_model_training(config_name, train_args):
    ...
    train_script_path = "experiments/training/train_organism.py"
    ...
    try:
        ...
        if custom_folder_name:
            ...
            output_dir = os.path.join(project_root, "outputs/model_checkpoints")
...
def run_probe_pipeline(model_checkpoint_path, mode="medium", target_layers="12", probe_type="logistic", custom_args=None):
    ...
    probe_pipeline_script = "experiments/pipeline/run_probe_pipeline.py"
...
def run_likelihood_and_gen_pipeline(model_checkpoint_path, mode="medium"):
    ...
    likelihood_pipeline_script = "experiments/pipeline/evaluate_behavior_preservation.py"
    likelihood_cmd = [sys.executable, likelihood_pipeline_script, "--model_checkpoint", model_checkpoint_path]
...
def main():
    ...
    parser.add_argument(
        "--model-probe-dataset",
        type=str,
        default="ablit_12ablit-synth_12synth-21PRESET",
        help="Combined model-probe-dataset configuration selecting base model, probe checkpoint "
             ...
             "the paper's main configuration (abliterated Gemma-2-9b, 1-layer logistic probes, "
             "12-concept preset dataset)."
    )
    parser.add_argument(
        "--configs-json",
        type=str,
        default="experiments/pipeline/model_configs.json",
        help="Path to JSON file containing model configurations (default: experiments/pipeline/model_configs.json)"
    )
    parser.add_argument(
        "--probe-checkpoint",
        type=str,
    ...
    if args.model_probe_dataset == "ablit_12ablit-synth-mlp_12synth-21PRESET":
        ...
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_sept8_mlp_12ablit_4e-5"
    ...
    # 1-layer 12-probe ATTN preset
        ...
        base_model_name = "gemma_2_9b_it_abliterated_ilya"
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_sept8_attention_12ablit_4e-5"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train_PRESET.json"
    ...
    # 1-layer 12-probe preset
        ...
        base_model_name = "gemma_2_9b_it_abliterated_ilya"
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_aug21_ablit_0075_4e-5_no_gibberish"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train_PRESET.json"
    elif args.model_probe_dataset == "base_12base-synth_12synth-21PRESET":
        base_model_name = "gemma_2_9b_instruct"
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_aug12_75_4e-5_no_gibberish"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train_PRESET.json"

    # 4-layer 12-probe preset
    elif args.model_probe_dataset == "ablit_12ablit-synth-4l_12synth-21PRESET":
        base_model_name = "gemma_2_9b_it_abliterated_ilya"
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_sept4_4_layers_12ablit_4e-5"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train_PRESET.json"
    elif args.model_probe_dataset == "base_12base-synth-4l_12synth-21PRESET":
        base_model_name = "gemma_2_9b_instruct"
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_sept4_4_layers_12base_4e-5"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train_PRESET.json"

    # 8-layer 12-probe preset
    elif args.model_probe_dataset == "ablit_12ablit-synth-8l_12synth-21PRESET":
        base_model_name = "gemma_2_9b_it_abliterated_ilya"
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_sept4_8_layers_12ablit_4e-5"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train_PRESET.json"
    elif args.model_probe_dataset == "base_12base-synth-8l_12synth-21PRESET":
        base_model_name = "gemma_2_9b_instruct"
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_sept4_8_layers_12base_4e-5"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train_PRESET.json"
    ...
    # Qwen 2 7B Instruct 1-layer 12-probe
        ...
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_qwen_layer9_12concepts_4e-5"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train.json"
    ...
    # Qwen 2.5 7B Instruct Abliterated 1-layer 12-probe
        ...
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_qwen_abliterated_layer9_12concepts_4e-5"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train.json"
    ...
    # Gemma 3 4B Abliterated 1-layer 12-probe
        ...
        probe_checkpoint_regular = "outputs/probe_checkpoints/probes_gemma3_4b_layer10_12concepts_4e-5"
        training_dataset = "mega_dataset_evaluated_20250729_144844_harm_batch_train.json"
        do_no_filtering = True
    ...
    if probe_checkpoint_regular:
        ...
        if not os.path.exists(metadata_path):
            raise FileNotFoundError(
                ...
                "Options:\n"
                "  1. Train probes first: python experiments/pipeline/run_probe_pipeline.py <checkpoint>\n"
    ...
    pipeline_output_dir = "outputs/model_checkpoints"
