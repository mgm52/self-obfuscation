...
from data.synthetic_rating.load_rated_data import load_rated_data  # type: ignore
...
def main():
    ...
    rated_dataset_path = "data/synthetic_rating/outputs/mega_dataset_evaluated_20250731_163529_harm_batch_test_TEST.json"
    merged_concepts = [
    ...
    output_base = f"outputs/behavior_preservation/{model_basename}_{timestamp}_likelihoods"
