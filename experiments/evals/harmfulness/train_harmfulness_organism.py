...
- Trained harmfulness probe from outputs/probe_checkpoints/20250701_041309_logistic_baseline_harmful
...
def train_harmful_self_obfuscation_model(
    ...
    probe_checkpoint: str = "outputs/probe_checkpoints/20250701_041309_logistic_baseline_harmful",
    num_samples: int = 1000,
    num_epochs: int = 3,
    ...
    if not custom_folder_name:
        checkpoint_path = f"outputs/model_checkpoints/checkpoint_{datetime.now().strftime('%Y%m%d_%H%M%S')}_harmful"
    else:
        checkpoint_path = f"outputs/model_checkpoints/{custom_folder_name}"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--probe_checkpoint', type=str,
                      default="outputs/probe_checkpoints/20250701_041309_logistic_baseline_harmful",
